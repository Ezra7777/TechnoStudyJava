...
public class StringReplace {
    ...
    // The replace() method does not actually replace characters in the existing String.Rather,it turns a new String instance which is egual to the String instance it was created from, but with the given characters replaced.
