...
//Answers:
//A
//Base show method called//true when a function is static, runtime polymorphism doesn’t happen.
//B
//Derived show method called
//C
//Compiler Error
...
//Answers:
//A
//Compiler Error in super.super.Print()//true In Java, it is not allowed to do super.super. We can only access Grandparent’s members using Parent. For example, the following program works fine
//B
//Grandparent's Print()
//Parent's Print()
//Child's Print()
...
//}
//Answers:
//Complex number is (10.0 + 15.0i) //true
//B
//Compiler Error
//C
